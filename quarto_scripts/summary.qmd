...
fastqc_path <- file.path(subdirs[grepl("_R1_\\d+_fastqc$", subdirs)], "fastqc_data.txt")
fastqc_lines <- readLines(fastqc_path)
cat(fastqc_lines[7], "\n")
cat(fastqc_lines[8], "\n")

summary_path <- file.path(subdirs[grepl("_R1_\\d+_fastqc$", subdirs)], "summary.txt")
...
subdirs <- list.dirs(pretrim_qc.dir, full.names = TRUE, recursive = FALSE)
fastqc_path <- file.path(subdirs[grepl("_R2_\\d+_fastqc$", subdirs)], "fastqc_data.txt")
fastqc_lines <- readLines(fastqc_path)
cat(fastqc_lines[7], "\n")
cat(fastqc_lines[8], "\n")

summary_path <- file.path(subdirs[grepl("_R2_\\d+_fastqc$", subdirs)], "summary.txt")
summary_lines <- readLines(summary_path)
...
fastqc_path <- file.path(subdirs[grepl("unzipped_forward/forward_paired_fastqc$", subdirs)], "fastqc_data.txt")
fastqc_lines <- readLines(fastqc_path)
cat(fastqc_lines[7], "\n")
cat(fastqc_lines[8], "\n")

summary_path <- file.path(subdirs[grepl("unzipped_forward/forward_paired_fastqc$", subdirs)], "summary.txt")
summary_lines <- readLines(summary_path)
...
subdirs <- list.dirs(qc.dir, full.names = TRUE, recursive = TRUE)
fastqc_path <- file.path(subdirs[grepl("unzipped_reverse/reverse_paired_fastqc$", subdirs)], "fastqc_data.txt")
fastqc_lines <- readLines(fastqc_path)
cat(fastqc_lines[7], "\n")
cat(fastqc_lines[8], "\n")

summary_path <- file.path(subdirs[grepl("unzipped_reverse/reverse_paired_fastqc$", subdirs)], "summary.txt")
summary_lines <- readLines(summary_path)
