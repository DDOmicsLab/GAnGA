...
``` bash
genovi -i {sample_dir/09_bakta/{sample_name}_bakta.gbff} -o genovi -s draft --title {sample_name} --cogs ABCDEFGHIJKLMNOPQRSTUVWXYZ -cs paradise -bc white  &> {sample_dir/logs/genovi.log}
