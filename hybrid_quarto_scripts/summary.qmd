...
fastqc_path <- file.path(subdirs[grepl("_1_fastqc$", subdirs)], "fastqc_data.txt")
fastqc_lines <- readLines(fastqc_path)
cat(fastqc_lines[7], "\n")
cat(fastqc_lines[8], "\n")

summary_path <- file.path(subdirs[grepl("_1_fastqc$", subdirs)], "summary.txt")
...
subdirs <- list.dirs(pretrim_qc.dir, full.names = TRUE, recursive = FALSE)
fastqc_path <- file.path(subdirs[grepl("_2_fastqc$", subdirs)], "fastqc_data.txt")
fastqc_lines <- readLines(fastqc_path)
cat(fastqc_lines[7], "\n")
cat(fastqc_lines[8], "\n")

summary_path <- file.path(subdirs[grepl("_2_fastqc$", subdirs)], "summary.txt")
summary_lines <- readLines(summary_path)
